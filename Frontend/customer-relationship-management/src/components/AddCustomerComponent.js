...
export default class AddCustomerComponent extends Component {
  ...
  addCustomer = (e) => {
    ...
    CustomerService.addCustomer(firstName, lastName, gender, phone, email, designation, permanentAddress, currentAddress)
    .then(response=>{
      this.setState({
        isSuccess: true,
        errorOccured: false,
                    ...
                    <div className="col-md border-right">
                      <div className="p-3 py-5">
                        ...
                        <div className="row">
                          <div className="col-sm-12 col-md-6 col-lg-4">
                            <div className="form-floating mb-3">
                              <input type="text" name="email" onChange={this.handleChange} value={this.state.email} placeholder="Enter email" required className="form-control" />
